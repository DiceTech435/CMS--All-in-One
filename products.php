 ...
 <div class="main">
    <div class="main_container">
        <div class="main_content">
            <h1>OUR TREMENDIOUS PRODUCTS,</h1>
            <h2>SALES AND SERVICES</h2>
            <p>See what makes us different.</p>
            <button class="main_btn"><a href="signup.html">Get started</a></button>
        </div>
        <div class="main_img-conatiner">
            <img src="images/data-trends.svg" alt="MainPic" id="main_img">
        </div>
    </div>
 </div>
 ...
 <!-- Services Section -->
  <div class="services">
    ...
    <div class="services_container">
        ...
        <div class="services_card" style="background-image: url(/images/product1.jpg);">
            <h2>Experience Bliss</h2>
            <p>AI Powered Technology</p>
            <button><a href="signup.php">Get started</a></button>
        </div>
        <div class="services_card" style="background-image: url(/images/product2.jpg);">
            <h2>Are you ready</h2>
            <p>Take teh leap</p>
            <button><a href="signup.php">Get started</a></button>
        </div>
